 ...
 */
?>
<div class="group-content group-collapsed-list large-12">
  <dt>
    <a id="<?php print $term->id; ?>" class="collapsed-list-link-wrapper">
      <div class="field field-type-text field-label-hidden field-wrapper">
        <h3 class="field-item even"><?php print $term->safe_name; ?></h3>
      </div>
    </a>
  ...
  <?php if (isset($term->safe_description) || isset($term->synonyms) || isset($term->image) || isset ($term->related) || (isset($term->field_source) && !empty($term->field_source))) : ?>
    <dd class="collapsed-list-hidden">
      ...
      <?php endif; ?>
      <?php if (isset($term->field_source) && !empty($term->field_source)) : ?>
        <div class="lexicon-source">
          <span><?php print t('Source') . ': ' ?></span>
          <?php
            $field_language = field_language('taxonomy_term', $term, 'field_source');
            print $term->field_source[$field_language][0]['safe_value'];
          ?>
        </div>
      <?php endif; ?>
